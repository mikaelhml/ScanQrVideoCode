...
public final class Encoder {
   ...
   *   or configuration
   */
  public static QRCode encode(byte[] content, ErrorCorrectionLevel ecLevel) throws WriterException {
  ...
  static void append8BitBytes(byte[] bytes, BitArray bits, String encoding) throws WriterException {
    for (byte b : bytes) {
      bits.appendBits(b, 8);
    }
  }
